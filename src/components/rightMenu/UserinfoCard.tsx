        ...
        <div className='flex flex-col gap-4 text-gray-500'>
            ...
            <div className='flex items-center justify-between'>
                ...
                <div className='flex gap-1 items-center'>
                    ...
                    height={16}
                    />
                    <span>Joined <b>{formattedDate}</b></span>
                </div>
            </div>
            <UserInfoCardInteraction userId = {user.id} currentUserId = {currentUserId} isUserBlocked = {isUserBlocked} isFollowing = {isFollowing}
            isFollowingSent = {isFollowing}/>
        </div>
    </div>
  )
}
